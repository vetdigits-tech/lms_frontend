...
export default function CheckoutPage() {
  ...
  const handlePayment = async () => {
    try {
      ...
      const sessionRes = await fetch(`${API_URL}/api/checkout/create-session`, {
        method: 'POST',
        credentials: 'include',
        headers: {
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            ...
            <p className="mb-6">Do you want to cancel and return to dashboard?</p>
        ...
        <div className="flex flex-col lg:flex-row gap-8 bg-white p-6 rounded-lg shadow">
          ...
          <div className="w-full lg:w-1/3 bg-gray-50 p-6 rounded-lg shadow space-y-6">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-blue-800">₹{course.price}</span>
            </div>
            <div className="flex justify-between">
