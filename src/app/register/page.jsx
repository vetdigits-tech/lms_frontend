  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 p-4">
      ...
      <div className="relative w-full max-w-xs sm:max-w-sm">
        {/* Ultra Compact Square Register Card */}
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white/95 backdrop-blur-xl shadow-2xl border border-white/20">
          ...
          {/* Very Compact Header */}
          <div className="relative bg-gradient-to-br from-indigo-600 via-purple-700 to-blue-800 px-4 py-4 sm:px-6 sm:py-5 text-center">
            ...
            <div className="relative">
              ...
              <h1 className="text-lg sm:text-xl font-bold text-white mb-1">Create Account</h1>
              <p className="text-indigo-100 text-xs hidden sm:block">Join VetDigit today</p>
            </div>
          </div>
          ...
          <div className="px-4 py-4 sm:px-6 sm:py-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              {/* Username - Ultra Compact */}
              <div>
                <label className="text-xs font-medium text-gray-700 block mb-1">Name</label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 h-3 w-3 sm:h-4 sm:w-4 -translate-y-1/2 text-gray-400" />
                  <input
                    name="username"
                    type="text"
                    required
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-gray-50/50 pl-8 sm:pl-10 pr-3 py-2 sm:py-2.5 text-xs sm:text-sm text-gray-900 placeholder-gray-500 transition-all focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 bg-gray-50/50 pl-8 sm:pl-10 pr-8 sm:pr-10 py-2 sm:py-2.5 text-xs sm:text-sm text-gray-900 placeholder-gray-500 transition-all focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:outline-none"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full overflow-hidden rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 py-2.5 sm:py-3 text-xs sm:text-sm text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
              >
